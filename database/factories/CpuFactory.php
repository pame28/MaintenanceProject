...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\AppModelsCpu>
 */
class CpuFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'storage_capacity' => $this->faker->randomElement(['256 GB', '512 GB', '1 TB']),
            'ram' => $this->faker->randomElement(['4 GB', '8 GB', '16 GB']),
            'cpu_status' => $this->faker->randomElement(['Disponible', 'Asignado', 'En mantenimiento', 'Obsoleto']),
